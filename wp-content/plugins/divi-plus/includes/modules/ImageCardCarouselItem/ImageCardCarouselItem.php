...
class DIPL_ImageCardCarouselItem extends ET_Builder_Module {
	...
	public function init() {
		$this->name 						= esc_html__( 'DP Image Card Carousel Item', 'divi-plus' );
		$this->advanced_setting_title_text  = esc_html__( 'Image Card Carousel Item', 'divi-plus' );
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( '' !== $icon ) {
            ...
            /* Add margin to icon */
			et_pb_responsive_options()->generate_responsive_css( $margin_values, '%%order_class%% .dipl_image_card_icon_wrapper', 'margin-top', $render_slug, '', 'range' );
